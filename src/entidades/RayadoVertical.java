...
/**
 * Modela el comportamiento de los Rayados Verticales.
 */
public class RayadoVertical extends Potenciador {

    protected static final int PUNTAJE = 35;
	
    public RayadoVertical(int f, int c, Color col, String img_path, Tablero t) {
