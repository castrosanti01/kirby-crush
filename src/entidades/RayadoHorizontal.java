...
/**
 * Modela el comportamiento de los Rayados Horizontales.
 */
public class RayadoHorizontal extends Potenciador {

    protected static final int PUNTAJE = 45;
	
    public RayadoHorizontal(int f, int c, Color col, String img_path, Tablero t) {
